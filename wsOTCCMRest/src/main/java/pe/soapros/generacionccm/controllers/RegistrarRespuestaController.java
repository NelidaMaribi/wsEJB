	...
	public Respuesta respuestaSolicitud(String StrsolicitudIn) {
		try {
			...
			if (strSolicitudValida == null) {
				...
				resp_builder.entity(exceptionsUtils.setException("Error al validar el objeto de Solicitud", "uri=/registrar/pedido"));
			...
			if (respuesta != null) {
				...
				String strRespuesta = peticionBO.procesarPeticion(mapper.writeValueAsString(respuesta), mapper.writeValueAsString(solicitud));
	        ...
	        if ("".equals(o.getSistema()) || "null".equals(o.getSistema()) || o.getSistema() == null) {
	            ...
	            if (validado == null) {
	            	...
	            	throw new JsonProcessingException(
	                        "origen.sistema, No se encontró el sistema.") {
	            ...
	            if (!validado) {
	            	logger.debug("ERROR {}", "origen.sistema, El Sistema ingresado no tiene permisos para hacer una solicitud");
	                throw new JsonProcessingException(
